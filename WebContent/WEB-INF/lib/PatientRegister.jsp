...
<body>
    ...
    <div  class="div1">
        ...
        <div class="lables">
             ...
             <input class="text2" type="text" name="" id="">
             <input type="text" class="text3" name="" id="">
             <input type="text" class="text4" name="" id=""><br>
             ...
             <input type="text" class="add1" name="" id=""><br>
             <label for=""class="addlable1">Street Address</label><br><br>

             <input type="text" class="add1" name="" id=""><br>
             <label for="" class="addlable2">Street Address line2</label><br><br>

             <input type="text" name="" class="text2" id="">
             <input type="text" name="" class="text3" id=""><br>
             ...
             <input type="text" name="" class="text2" id=""><br><br>
             ...
             <input type="text" name="" class="text4" id="">
             ...
             <input type="text" name="" class="add1" id=""><br><br>

            <input type="submit" class="btn1" value="Register Now">
